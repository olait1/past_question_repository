...
<body>
<div class="topnav " style="position:fixed; width:100%;z-index:1;" id="myTopnav">
<p class="brand-Name"> <a href="#"><img src="img/logo.png" style="width:50px"> </a>
<p class="text-white">The Federal Polytechnic, Bida<br/><i>P.M.B 55, Bida Niger State</i></p>
</p>
...
<div class="mySlides fade">
  ...
  <img src="img/bg (2).jpg" style="width:100%">
...
<div class="mySlides fade">
  ...
  <img src="img/bg (3).jpg" style="width:100%">
  <div class="text"></div>
</div>
...
<div style="text-align:center">
  ...
  <div class="row mt-5 container mb-5" style="margin:0px auto;">
    ...
    <img src="img/img (5).jpeg" alt="" style="width:100%" srcset="">
    ...
    <img src="img/img (4).jpg" alt="" style="width:100%" srcset="">
    <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
     At quaerat labore sed eius rerum earum dolore praesentium, 
    vitae nulla iste dolorum asperiores atque qui natus omnis recusandae? Quae, 
    facilis amet.</p>
    ...
    <img src="img/img1 (7).jpg" alt="" style="width:100%" srcset="">
    <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
     At quaerat labore sed eius rerum earum dolore praesentium, 
    vitae nulla iste dolorum asperiores atque qui natus omnis recusandae? Quae, 
    facilis amet.</p>
