...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for items..">
      ...
      <table id="myTable" style="">
          ...
          $sql="SELECT * FROM admin where cc='$id'";
          ...
          if ($result) {
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  ?>
                  <tr><form action="" method="post" style>
                  ...
                  <td ><span style="cursor:pointer; color:#00f;" title="<?php echo $ctittle;?>"><?php print $cc; ?></span></td>
                  <td ><span >
                  <?php echo $year;?>
                  </span></td>
                <td><a href="<?php print $pq;  ?>" download="upload/<?php print $cc; ?>">Download</a></td>
                  <td><a href="upload/<?php print $pq; ?>" target="_blank" rel="noopener noreferrer">Preview</a></td>
              </form></tr>
                  <?php
              }}
              ?>
